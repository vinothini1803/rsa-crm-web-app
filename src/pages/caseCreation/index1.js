...
import { CreateCaseData, setCaseData, CaseSMSId } from "../../../store/slices/caseSlice";
...
const CaseCreation = () => {
  ...
  const { data: caseVehicleModelData } = useQuery(
    ...
    () =>
      getCaseVehicleModel({
        search:
          caseGetFormData?.data?.data?.extras?.policyDetails?.vehicle_model,
        apiType: "dropdown",
      ...
      onSuccess: (res) => {
        ...
        if (res?.data?.success) {
          const selectedModel = res?.data?.data?.find(
            (el) =>
              el.name.toLowerCase() ==
              caseGetFormData?.data?.data?.extras?.policyDetails?.vehicle_model?.toLowerCase()
          );
          if(selectedModel) {
  ...
  const { data: fullEntitlementServiceData, mutate: fullEntitlementServiceMutate} = useMutation(getFullServiceEntitlements);

  const { data: caseCreateMutateData, mutate: createCaseMutate, isLoading: caseCreateLoading, } = useMutation(createCaseInfo);

  const { data: caseMembershipListData, mutate: caseMembershipListMutate, isLoading: caseMembershipListLoading, } = useMutation(getMembershipTypes);

  const { data: memeberGetData, mutate: memberMutate, isLoading: memberLoading, } = useMutation(memberShipCaseCreation);

  const { data: caseGetFormData, isLoading: caseFormDataMutateLoading, } = useQuery(['getFormDataCreateCase', id], () => getFormDataCreateCase({
    id: id
  }), {
    ...
    onSuccess: (response) => {
      ...
      if (response?.data?.success) {
        ...
        if(response?.data?.data?.extras?.policyDetails) {
          fullEntitlementServiceMutate({
            clientId: response?.data?.data?.clientId,
            vin: response?.data?.data?.vin,
            vehicleRegistrationNumber: response?.data?.data?.vehicleRegistrationNumber || null,
        ...
        caseMembershipListMutate(
          { clientName: response?.data?.data?.clientName },
          {
            onSuccess: (res) => {
              ...
              if (res?.data?.success) {
                methods.setValue("serviceEligibility", res?.data?.membership_types?.find((item) => item?.id == response?.data?.data?.extras?.policyDetails?.membership_type_id));
              } else {
                if (res?.data?.error) {
    ...
    //case creation membership details used to get fuel type,policies,vehicle details
      memberMutate(
           ...
           },
          {
            onSuccess: (res) => {
              ...
              if (res?.data?.success) {
                ...
                methods.setValue("fuelType",res?.data?.vehicle_details?.fuel_type)
        ...
        if(response?.data?.data?.contactName) {
          methods.setValue("contactName", response?.data?.data?.contactName?.toString()?.toUpperCase());
          methods.setValue("isSameasContact", true)
        }
        if(response?.data?.data?.mobileNumber) {
          methods.setValue("mobileNumber", response?.data?.data?.mobileNumber);
        }
        if(response?.data?.data?.mobileNumber) {
          methods.setValue("alternateMobileNumber", response?.data?.data?.mobileNumber);
        }
        ...
        if(response?.data?.data?.currentContactLanguageId) {
          methods.setValue(
            ...
            response?.data?.data?.extras?.currentContactLanguages?.find(
              (item) => item?.id == response?.data?.data?.currentContactLanguageId
            )
          );
        }
        ...
        if(response?.data?.data?.vehicleRegistrationNumber) {
          methods.setValue(
            "vehicleNumber",
            response?.data?.data?.vehicleRegistrationNumber?.toString()?.toUpperCase()
          );
        }
        if(response?.data?.data?.vin) {
          methods.setValue("basicVinNumber", response?.data?.data?.vin?.toString()?.toUpperCase());
        }
        if (response?.data?.data?.extras?.policyDetails?.vehicle_type) {
          methods.setValue(
            "vehicleType",
            response?.data?.data?.extras?.vehicleTypes?.find(
              (item) =>
                item?.name?.toLowerCase() ==
                response?.data?.data?.extras?.policyDetails?.vehicle_type?.toLowerCase()
            )
          );
        }
        if (response?.data?.data?.extras?.policyDetails?.vehicle_make) {
          methods.setValue(
            "vehicleManufacturer",
            response?.data?.data?.extras?.vehicleMakes?.find(
              (item) =>
                item?.name?.toLowerCase() ==
                response?.data?.data?.extras?.policyDetails?.vehicle_make?.toLowerCase()
            )
          );
        }
        ...
        if (response?.data?.data?.extras?.policyDetails?.sale_date) {
          methods.setValue(
            "saleDate",
            moment(
              response?.data?.data?.extras?.policyDetails?.sale_date
            ).toDate()
          );
        }
        if (response?.data?.data?.extras?.policyDetails?.policy_type) {
          methods.setValue(
            "policyType",
            response?.data?.data?.extras?.policyTypes?.find(
              (item) =>
                item?.name?.toLowerCase() ==
                response?.data?.data?.extras?.policyDetails?.policy_type?.toLowerCase()
            )
          );
        } else {
          methods.setValue(
        ...
        if (response?.data?.data?.extras?.policyDetails?.policy_number) {
          methods.setValue(
            "policyNumber",
            response?.data?.data?.extras?.policyDetails?.policy_number?.toString()?.toUpperCase()
          );
        }
        if (response?.data?.data?.extras?.policyDetails?.start_date) {
          methods.setValue(
            "policyStartDate",
            moment(
              response?.data?.data?.extras?.policyDetails?.start_date
            ).toDate()
          );
        }
        if (response?.data?.data?.extras?.policyDetails?.end_date) {
          methods.setValue(
            "policyEndDate",
            moment(
              response?.data?.data?.extras?.policyDetails?.end_date
            ).toDate()
          );
        }
      } else {
  ...
  const { data: entitlementDetailsData, mutate: entitlementDetailsMutate } = useMutation(getEntitlementDetails);
  ...
  useEffect(() => {
    if (
      ...
      entitlementDetailsMutate({
        ...
        policyTypeId: caseGetFormData?.data?.data?.extras?.policyDetails?.policy_type ? caseGetFormData?.data?.data?.extras?.policyTypes?.find((item) => item?.name?.toLowerCase() == caseGetFormData?.data?.data?.extras?.policyDetails?.policy_type?.toLowerCase())?.id : 434,
        policyNumber: caseGetFormData?.data?.data?.extras?.policyDetails?.policy_type ? caseGetFormData?.data?.data?.extras?.policyDetails?.policy_number : null, //nullable
        policyStartDate: caseGetFormData?.data?.data?.extras?.policyDetails?.policy_type ? moment(caseGetFormData?.data?.data?.extras?.policyDetails?.start_date).format("YYYY-MM-DD") : null,
        policyEndDate: caseGetFormData?.data?.data?.extras?.policyDetails?.policy_type ? moment(caseGetFormData?.data?.data?.extras?.policyDetails?.end_date).format("YYYY-MM-DD") : null,
        ...
        breakdownToDropDistance: selectedDealerToBreakdownDistance
          ...
          :  selectedDropToBreakdownDistance ? selectedDropToBreakdownDistance : null, // service is towing means required (Field: Dealer to Breakdown Distance)
        ...
        onSuccess: (res) => {
          ...
          if(res?.data?.success && res?.data?.data?.notes?.isNonMember) {
            if(caseGetFormData?.data?.data?.extras?.policyDetails?.policy_type) {
              methods.setValue(
                "policyType",
            ...
            if(caseGetFormData?.data?.data?.extras?.policyDetails?.policy_number) {
              methods.resetField("policyNumber")
            }
            if(caseGetFormData?.data?.data?.extras?.policyDetails?.start_date) {
              methods.resetField("policyStartDate")
            }
            if(caseGetFormData?.data?.data?.extras?.policyDetails?.end_date) {
            ...
            if(caseGetFormData?.data?.data?.extras?.policyDetails?.policy_type) {
              methods.setValue(
                "policyType",
                caseGetFormData?.data?.data?.extras?.policyTypes?.find(
                  (item) => item?.name?.toLowerCase() == caseGetFormData?.data?.data?.extras?.policyDetails?.policy_type?.toLowerCase()
                )
              );
            }
            if(caseGetFormData?.data?.data?.extras?.policyDetails?.policy_number) {
              methods.setValue("policyNumber", caseGetFormData?.data?.data?.extras?.policyDetails?.policy_number)
            }
            if(caseGetFormData?.data?.data?.extras?.policyDetails?.start_date) {
              methods.setValue("policyStartDate", moment(
                caseGetFormData?.data?.data?.extras?.policyDetails?.start_date
              ).toDate())
            }
            if(caseGetFormData?.data?.data?.extras?.policyDetails?.end_date) {
              methods.setValue("policyEndDate", moment(
                caseGetFormData?.data?.data?.extras?.policyDetails?.end_date
              ).toDate())
            }
          }
          if(res?.data?.success && !res?.data?.data?.notes?.customerNeedToPay) {
        ...
        <NewInteraction
          formOptions={{
            ...
            conditionOfVehicles:
              ...
              towingAdditionalSubServices: caseGetFormData?.data?.data?.extras?.towingAdditionalSubServices
          }}
          setFullEntitlementVisible={setFullEntitlementVisible}
          formErrors={formFields?.NewInteraction?.errors}
          entitlementData={(selectedCaseType && selectedCaseService) ? entitlementDetailsData?.data?.data : {result: fullEntitlementServiceData?.data?.data}}
      ...
      content: (
        <BasicInfo
          formOptions={{
            ...
            fuelTypes: memeberGetData?.data?.fuelTypes,
            ...
            policyDetails: caseGetFormData?.data?.data?.extras?.policyDetails,
          }}
          setFullEntitlementVisible={setFullEntitlementVisible}
  ...
  const onErrorTab = (formData) => {
    ...
    const Errortabkey = errorTabs?.find(
      (el) => Object.values(el?.errors)?.length > 0)?.tabkey;
    ...
    if (Errortabkey !== undefined) {
      ...
      } else if (formData?.dropdownlocation?.description && (formData?.droparea?.id == undefined)) {
        toast.error("Please Select a Valid Drop Area");
      } else {
        console.log("entitlementDetailsData?.data?.data?.notes?.customerNeedToPa", entitlementDetailsData?.data)
        //API Mutation
        createCaseMutate(
          {
            ...
            customerAlternateMobileNumber: formData?.alternateMobileNumber || null,
            voiceOfCustomer: formData?.voiceCustomer,
            dispositionId: formData?.disposition?.id,
            contactLanguageId: formData?.contactLanguage?.id,
            customerCurrentContactLanguageId: formData?.currentContactLanguage?.id,
            ...
            ...(formData?.service?.id == 1 ? {
              additionalServiceId: caseGetFormData?.data?.data?.extras?.towingAdditionalServiceId,
              additionalSubServiceId: formData?.additionalSubServiceId?.id || null,
              ...((formData?.additionalSubServiceId?.id !== null && formData?.additionalSubServiceId?.id !== undefined) ? {
                // hasAspAssignment: formData?.hasAspAssignment == "Yes" ? true : false,
                hasAspAssignment: formData?.additionalSubServiceId?.hasAspAssignment,
              } : {})
            } : {}),
            ...
            serviceIsImmediate:subServiceForm?.getValues("serviceIsImmediate")?.[0]=="Immediate"?true:false,
            serviceInitiatingAt: subServiceForm?.getValues("serviceIsImmediate")?.[0]=="Later"?moment(subServiceForm?.getValues("serviceInitiatingAt"), "ddd MMM DD YYYY HH:mm:ss [GMT]Z").format("YYYY-MM-DD HH:mm:ss"):"",
            serviceExpectedAt: subServiceForm?.getValues("serviceIsImmediate")?.[0]=="Later"?moment(subServiceForm?.getValues("serviceExpectedAt"), "ddd MMM DD YYYY HH:mm:ss [GMT]Z").format("YYYY-MM-DD HH:mm:ss"):"",
            aspAutoAllocation: subServiceForm?.getValues("aspAutoAllocation"),
//Additional service auto allocation
    additionalServiceIsImmediate: formData?.additionalSubServiceId?.id ? (formData?.additionalSubServiceId?.id != undefined && additionalServiceForm?.getValues("additionalServiceIsImmediate")?.[0]=="Immediate")?true:false:null,
    additionalServiceInitiatingAt:(formData?.additionalSubServiceId?.id != undefined &&additionalServiceForm?.getValues("additionalServiceIsImmediate")?.[0]=="Later")?moment(additionalServiceForm?.getValues("additionalServiceInitiatingAt"), "ddd MMM DD YYYY HH:mm:ss [GMT]Z").format("YYYY-MM-DD HH:mm:ss"):"",
    additionalServiceExpectedAt: (formData?.additionalSubServiceId?.id != undefined && additionalServiceForm?.getValues("additionalServiceIsImmediate")?.[0]=="Later")?moment(additionalServiceForm?.getValues("additionalServiceExpectedAt"), "ddd MMM DD YYYY HH:mm:ss [GMT]Z").format("YYYY-MM-DD HH:mm:ss"):"",
    additionalServiceAspAutoAllocation:  formData?.additionalSubServiceId?.id != undefined ? additionalServiceForm?.getValues("additionalServiceAspAutoAllocation"):false,
    agentAutoAllocation: (subServiceForm?.getValues("serviceIsImmediate")?.[0]=="Immediate"|| additionalServiceForm?.getValues("additionalServiceIsImmediate")?.[0]=="Immediate") ? agentAutoAllocation == true ? false : true:false
          },
          {
            onSuccess: (response) => {
              if (response?.data?.success) {
                setActiveIndex(0);
                dispatch(setCaseData({ createCase: null, caseSMSId: null, existingCaseSMSId: null}));
                navigate("/cases");
  ...
  return (
    <div className="page-wrap">
          ...
          <div className="page-content-footer">
            <div className="d-flex align-items-center justify-content-between">
              <div className="d-flex gap-2 ms-auto">
                {activeIndex !== 0 && (
                  <button type="button" className="btn btn-white" onClick={handleBack}>
                    Back
                  </button>
                )}
      ...
      <RateCardSidebar visible={visible} setVisible={setVisible} client={selectedAccount} service={selectedCaseService} />
      <FullEntitlementSidebar 
        visible={fullEntitlementVisible} 
        setVisible={setFullEntitlementVisible} 
        caseData={{
          ...caseGetFormData?.data?.data,
          policyTypeId: caseGetFormData?.data?.data?.extras?.policyDetails?.policy_type ? 
          caseGetFormData?.data?.data?.extras?.policyTypes?.find((item) => item?.name?.toLowerCase() == caseGetFormData?.data?.data?.extras?.policyDetails?.policy_type?.toLowerCase())?.id : 434,
        }} 
