...
const CaseCreation = () => {
  ...
  const { data: caseVehicleModelData } = useQuery(
    ...
    () =>
      getCaseVehicleModel({
        search:
        memberGetData?.data?.vehicle_detail?.vehicle_model,
        apiType: "dropdown",
      ...
      onSuccess: (res) => {
        ...
        if (res?.data?.success) {
          const selectedModel = res?.data?.data?.find(
            (el) =>
              el.name.toLowerCase() ==
            memberGetData?.data?.vehicle_detail?.vehicle_model?.toLowerCase()
          );
          if(selectedModel) {
  ...
  const { data: memberGetData, mutate: memberMutate, isLoading: memberLoading, } = useMutation(memberShipCaseCreation);
  console.log("memeberGetData", memberGetData)
           ...
           },
          {
            onSuccess: (res) => {
              ...
              if (res?.data?.success) {
                  ...
                  methods.setValue("fuleType",res?.data?.fuelTypes?.find(
                  (item) =>
                ...
                if(res?.data?.policy_detail) {
                  fullEntitlementServiceMutate({
                    ...
                    // policyTypeId: response?.data?.data?.extras?.policyDetails?.policy_type ? 
                    // response?.data?.data?.extras?.policyTypes?.find((item) => item?.name?.toLowerCase() == response?.data?.data?.extras?.policyDetails?.policy_type?.toLowerCase())?.id : 434,
                    policyTypeId: res?.data?.policy_detail ? response?.data?.data?.extras?.policyTypes?.find((item) => item?.name?.toLowerCase() == res?.data?.policy_detail?.policy_type?.toLowerCase())?.id : 434,
                    // policyNumber: response?.data?.data?.extras?.policyDetails?.policy_number || null, //nullable
                    policyNumber: res?.data?.policy_detail?.policy_number || null, //nullable
                    // membershipTypeId: response?.data?.data?.extras?.policyDetails?.membership_type_id || null, // policyTypeId rsa means required.
                      membershipTypeId: res?.data?.policy_detail?.membership_type_id || null, 
                    typeId: 1
                  })
                  ...
                  if (res?.data?.policy_detail) {
                    methods.setValue(
                      "saleDate",
                      moment(
                        res?.data?.policy_detail?.sale_date
                      ).toDate()
                    );
                  }
                  ...
                  if (res?.data?.policy_detail) {
                    methods.setValue(
                      "policyNumber",
                      res?.data?.policy_detail?.policy_number?.toString()?.toUpperCase()
                    );
                  }
                  if (res?.data?.policy_detail?.start_date) {
                    methods.setValue(
                      "policyStartDate",
                      moment(
                        res?.data?.policy_detail?.start_date
                      ).toDate()
                    );
                  }
                  ...
                  if (res?.data?.policy_detail?.end_date) {
                    methods.setValue(
                      "policyEndDate",
                      moment(
                        res?.data?.policy_detail?.end_date
                      ).toDate()
                    );
                  }
                }
                  ...
                  { clientName: response?.data?.data?.clientName },
                  {
                    onSuccess: (resp) => {
                      ...
                      if (resp?.data?.success) {
                        methods.setValue("serviceEligibility", resp?.data?.membership_types?.find((item) => item?.id == res?.data?.policy_detail?.membership_type_id));
                      } else {
                        if (resp?.data?.error) {
                          ...
                          resp?.data?.errors?.forEach((el) => toast.error(el));
                        } else {
  ...
  useEffect(() => {
    if (
      ...
      entitlementDetailsMutate({
        ...
        policyTypeId: memberGetData?.data?.policy_detail?.policy_type ? caseGetFormData?.data?.data?.extras?.policyTypes?.find((item) => item?.name?.toLowerCase() == memberGetData?.data?.policy_detail?.policy_type?.toLowerCase())?.id : 434,
     
        policyNumber: memberGetData?.data?.policy_detail?.policy_number  ? memberGetData?.data?.policy_detail?.policy_number : null, //nullable
        policyStartDate: memberGetData?.data?.policy_detail ? moment(memberGetData?.data?.policy_detail?.start_date).format("YYYY-MM-DD") : null,
        policyEndDate: memberGetData?.data?.policy_detail ? moment(memberGetData?.data?.policy_detail?.end_date).format("YYYY-MM-DD") : null,
          ...
          if(res?.data?.success && res?.data?.data?.notes?.isNonMember) {
            ...
            if(memberGetData?.data?.policy_detail?.policy_type) {
              methods.setValue(
                "policyType",
                caseGetFormData?.data?.data?.extras?.policyTypes?.find(
                  (item) => item?.name?.toLowerCase() == memberGetData?.data?.policy_detail?.policy_type?.toLowerCase()
                )
              );
            }
            if(memberGetData?.data?.policy_detail?.policy_number) {
              methods.setValue("policyNumber", memberGetData?.data?.policy_detail?.policy_number)
            }
            if(memberGetData?.data?.policy_detail?.start_date) {
            ...
            if(memberGetData?.data?.policy_detail?.end_date) {
              methods.setValue("policyEndDate", moment(
                memberGetData?.data?.policy_detail?.end_date
              ).toDate())
            }
          }
    ...
    <div className="page-wrap">
      ...
      <FullEntitlementSidebar 
        ...
        caseData={{
          ...
          caseGetFormData?.data?.data?.extras?.policyTypes?.find((item) => item?.name?.toLowerCase() == memberGetData?.data?.policy_detail?.policy_type?.toLowerCase())?.id : 434,
        }} 
