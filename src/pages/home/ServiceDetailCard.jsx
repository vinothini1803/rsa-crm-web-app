...
const ServiceDetailCard = ({
  ...
  const determineRowClassName = (rowData) => {
    ...
    const dynamicCondition = selectedCaseSubService
      ? rowData?.subService?.toString()?.toLowerCase() ===
        selectedCaseSubService?.name?.toString()?.toLowerCase()
        ? true
        : false
      : false;
    // console.log(
          ...
          <>
            <div className="company-name">
              {client
                ...
                : "Royal Sundaram Diversion"}
            </div>
            {entitlementData?.service && entitlementData?.policyData && (
              <div className="service-detail-card-header-chip">
                {entitlementData?.service}
              </div>
            )}
            {entitlementData?.policyData &&
              entitlementData?.fullScreenView !== false && (
                <div
                  className="screenview-icon"
                  onClick={() => setFullEntitlementVisible(true)}
                >
              ...
              {entitlementData?.customerServiceEntitlements?.length > 0 && (
                <>
                  ...
                  <DataTable
                    ...
                    emptyMessage={
                      <NoDataComponent
                        image={TableEmptyImage}
                        text="The Entitlement Service is currently not accessible for this policy."
                      />
                    }
                  >
        ...
        >
          {entitlementData?.policyData ? (
            <>
              ...
              {entitlementData?.policyData?.policyStartDate != "Invalid date" &&
              entitlementData?.policyData?.policyEndDate != "Invalid date" ? (
                <div className="date-contanier">
                  <img src={CalenderIcon} />
                  <div className="date">
                    {entitlementData?.policyData?.policyStartDate} -{" "}
